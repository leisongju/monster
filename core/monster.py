...
class Monster(nn.Module):
    def __init__(self, args):
        ...
        state_dict_dpt = torch.load(f'/mnt/datalsj/depth/Depth-Anything-V2/checkpoints/depth_anything_vitl14.pth', map_location='cpu')
    ...
    def forward(self, image1, image2, iters=12, flow_init=None, test_mode=False):
        ...
        gwc_volume = build_gwc_volume_with_negative_disp(match_left, match_right, self.args.max_disp//4, 8)
        ...
        init_disp = disparity_regression_with_negative_disp(prob, self.args.max_disp//4)
